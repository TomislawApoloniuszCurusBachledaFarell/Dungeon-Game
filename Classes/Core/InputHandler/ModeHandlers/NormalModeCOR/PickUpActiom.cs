...
public class PickUpAction : NormalHandler
{
    public PickUpAction() : base() { this.SetNext(new UnequipAction()); }
    protected override bool canHandle(ConsoleKey PressedKey, KeyDefinitions keyBinds)
    {
        return (PressedKey == keyBinds.GetActionKey(GameActions.PickUp));
    }
